...
export const projects: Project[] = [
  ...
  },
  {
    ...
    client: "Self-directed",
    shortDescription:
      "3D jewelry design — original brass and pearl pieces rendered with a minimal, editorial sensibility.",
    year: "2022",
    role: "Visual Designer",
    team: "Solo",
    duration: "3 weeks",
    tools: ["Blender", "Photoshop"],
    tags: ["Jewelry Design", "3D Design", "Visual Design"],
    category: "creative",
    status: "published",
    coverColor: "#C8B98A",
    ...
    coverFit: "cover",
    glowColor: "#C8A97A",
    overview: "Original jewelry designs — brass T-bar earrings, pearl drops, and sculptural pieces — modeled and rendered in Blender. The pieces were designed from scratch and presented in a clean, elevated environment to feel editorial rather than commercial.",
    gallery: [
      "/play/kendra-p1.jpg",
      "/play/kendra-p2.jpg",
      "/play/kendra-p3.jpg",
